...
SEMESTERS = {
    ...
    1: {
        ...
        "courses": [
            ...
            T("高等数学A（1）", 5.0, 96),
            T("土木工程防灾概论", 2.0, 32, category="普通选修", prefer=["晚上"]),
            T("社会学导论", 2.0, 32, category="普通选修", prefer=["晚上"]),
            T("大学生心理健康教育", 1.0, 16, category="普通选修", prefer=["晚上"], sessions_per_week=1,
              hours_per_session=2, weeks="1-8"),
            T("新中国史", 1.0, 16, category="普通选修", prefer=["晚上"], sessions_per_week=1,
              hours_per_session=2, weeks="9-16"),
        ],
        "semester_events": [
    ...
    3: {
        ...
        "courses": [
            ...
            T("复变函数与积分变换", 2.0, 32),
            T("离散数学", 2.0, 32),
            T("C++面向对象程序设计", 2.0, 32, category="普通选修", prefer=["晚上"]),
            T("软件技术基础", 2.0, 32, category="普通选修", prefer=["晚上"]),
    ...
    4: {
        ...
        "courses": [
            ...
            T("Python语言程序设计", 2.0, 32, category="普通选修", prefer=["晚上"]),
    ...
    6: {
        ...
        "courses": [
            ...
            T("电机控制技术", 2.0, 32),
            T("电气工程新技术导论", 2.0, 32, category="专业选修", prefer=["下午"], no_evening=True),
            T("新能源发电技术", 2.0, 32, category="专业选修", prefer=["下午"], no_evening=True),
            T("电力系统过电压", 2.0, 32, category="专业选修", prefer=["下午"], no_evening=True),
            T("高电压绝缘", 2.0, 32, category="专业选修", prefer=["下午"], no_evening=True),
