...
SEMESTERS = {
    ...
    1: {
        ...
        "courses": [
            ...
            T("四史·①", 1.0, 16, lecture=16, category="四史", type="四史", prefer=["晚上"],
              sessions_per_week=1, hours_per_session=2, weeks="1-8", elective_slot="hist1"),
        ],
        "semester_events": [
    ...
    2: {
        ...
        "courses": [
            ...
            T("四史·②", 1.0, 16, lecture=16, category="四史", type="四史", prefer=["晚上"],
              sessions_per_week=1, hours_per_session=2, weeks="9-16", elective_slot="hist2"),
        ],
    ...
    3: {
        ...
        "courses": [
            ...
            T("四史·③", 1.0, 16, lecture=16, category="四史", type="四史", prefer=["晚上"],
              sessions_per_week=1, hours_per_session=2, weeks="1-8", elective_slot="hist3"),
        ],
    ...
    4: {
        ...
        "courses": [
            ...
            T("四史·④", 1.0, 16, lecture=16, category="四史", type="四史", prefer=["晚上"],
              sessions_per_week=1, hours_per_session=2, weeks="9-16", elective_slot="hist4"),
        ],
        "semester_events": [
